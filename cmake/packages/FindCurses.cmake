...
find_path(CURSES_INCLUDE_DIRS ncursesw/curses.h ncurses/curses.h
...
#
find_library(NCURSES_LIBRARIES NAMES libncursesw.a libncurses.a
...
find_library(PANEL_LIBRARIES NAMES libpanelw.a libpanel.a
  PATHS ${LLVM_BUILD_ROOT__ROOTFS}/lib
  NO_DEFAULT_PATH
  NO_PACKAGE_ROOT_PATH
  NO_CMAKE_PATH
...
find_library(FORM_LIBRARIES NAMES libformw.a libform.a
  PATHS ${LLVM_BUILD_ROOT__ROOTFS}/lib
  NO_DEFAULT_PATH
  NO_PACKAGE_ROOT_PATH
  NO_CMAKE_PATH
...
find_library(MENU_LIBRARIES NAMES libmenuw.a libmenu.a
  PATHS ${LLVM_BUILD_ROOT__ROOTFS}/lib
  NO_DEFAULT_PATH
  NO_PACKAGE_ROOT_PATH
  NO_CMAKE_PATH
...
if(CURSES_INCLUDE_DIRS AND (EXISTS "${CURSES_INCLUDE_DIRS}/ncursesw/termcap.h" OR EXISTS "${CURSES_INCLUDE_DIRS}/ncurses/termcap.h"))
    set(HAVE_TERMCAP_H TRUE)
endif()

if(CURSES_INCLUDE_DIRS AND (EXISTS "${CURSES_INCLUDE_DIRS}/ncursesw/curses.h" OR EXISTS "${CURSES_INCLUDE_DIRS}/ncurses/curses.h"))
