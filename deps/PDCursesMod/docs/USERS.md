...
Data Types and the \<pdcurses_curses.h\> Header
--------------------------------------
...
### The \<pdcurses_curses.h\> Header

The \<pdcurses_curses.h\> header defines various constants and declares the data
...
This list is incomplete -- see pdcurses_curses.h for the full list, and use the
