...
- Optionally, run "make install". To avoid conflicts with any existing
  curses installations, copies of pdcurses_curses.h and pdcurses_panel.h are installed in
...
When compiling your application, you need to include the \<pdcurses_curses.h\>
