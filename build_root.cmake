...
macro(build_root_add_makefile_package src relative_path_to_makefile_dir build_dir new_line_seperated_extra_c_flags new_line_seperated_extra_cxx_flags new_line_seperated_extra_makefile_config)
  ...
  if (WIN32)
      ...
      string(TO_LOWER "${LLVM_BUILD_ROOT__ROOTFS__MSYS_LETTER_}" LLVM_BUILD_ROOT__ROOTFS__MSYS_LETTER)
      ...
      BUILD_ROOT_MESSAGE("LLVM_BUILD_ROOT__ROOTFS__MSYS__PATH = ${LLVM_BUILD_ROOT__ROOTFS__MSYS__PATH}")
      BUILD_ROOT_FATAL("LLVM_BUILD_ROOT__ROOTFS__MSYS_LETTER = ${LLVM_BUILD_ROOT__ROOTFS__MSYS_LETTER}")
