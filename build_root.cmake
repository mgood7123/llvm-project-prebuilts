  ...
  if (EXISTS "${CYGDIR}usr/bin/cygpath.exe")
    if (EXISTS "${CYGDIR}usr/lib/libmsys-2.0.a")
      ...
      if ("$ENV{MSYSTEM}" STREQUAL "MSYS")
        ...
        message("PLATFORM WINDOWS MSYS")
        set(BUILD_ROOT_OS__MSYS TRUE)
        set(BUILD_ROOT_OS__MSYS_PATH ${CYGDIR}$ENV{MINGW_PREFIX})
...
macro(build_root_init cmake_packages_dir build_root_dir)
  ...
  message("BUILD_ROOT_OS = ${BUILD_ROOT_OS}")
  if (BUILD_ROOT_OS__MSYS)
    message("BUILD_ROOT_OS__MSYS_PATH = ${BUILD_ROOT_OS__MSYS_PATH}")
  endif()
  if (BUILD_ROOT_OS__CYGWIN)
    message("BUILD_ROOT_OS__CYGWIN_PATH = ${BUILD_ROOT_OS__CYGWIN_PATH}")
  endif()
  message("ENV - CMAKE_BUILD_PARALLEL_LEVEL = $ENV{CMAKE_BUILD_PARALLEL_LEVEL}")
